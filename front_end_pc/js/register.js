var vm = new Vue({
	...
	data: {
		...
		allow: false,
		image_code_id:'', //uuid
		image_code_url:'', //访问后段视图地址，得到image
		sms_code_tip:'获取短信验证码',
		error_image_code_message:'',// 错误信息
		sending_flag: false, // 正在发送开关
		error_name_message:'',// 用户错误框信息
		error_phone_message:'', //手机提示错误信息
		error_sms_code_message:'',// 短信错误的提示信息
	},
	// 当模版渲染结束时会被调用
	mounted:function(){
		// 调用生成访问后段接口的地址
	...
	methods: {
		...
		generate_image_code:function(){
			this.image_code_id = this.generate_uuid();//生成一个uuid
